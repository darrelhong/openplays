...
<div class="flex-1 grid place-items-center">
	<div class="mx-4 p-6 pb-7 border border-stone-700 rounded-xl bg-stone-800 max-w-sm w-full">
		<div class="flex flex-col gap-6 items-center">
			<div class="mb-4 text-center flex flex-col gap-2 items-center">
				<h1 class="text-2xl text-stone-50 font-bold">Welcome to OpenPlays</h1>
				<p class="text-sm text-stone-400">Sign up or log in to create and manage your games.</p>
			</div>
