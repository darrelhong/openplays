		...
		<div class="flex gap-3 items-center">
			...
			{#if data.user}
				...
				<a
					...
					class="text-foreground gap-2 hidden items-center hover:text-foreground/80 sm:flex sm:order-3"
				>
					<UserAvatar
				...
				<form method="POST" action="/logout" class="hidden sm:block sm:order-4">
		...
		<footer class="p-4 flex gap-2 items-center">
			...
			<nav class="text-sm flex gap-3 items-center">
				<a href={resolve('/privacy')} class="text-muted hover:text-foreground hover:underline"
					>Privacy</a
				>
				<a href={resolve('/terms')} class="text-muted hover:text-foreground hover:underline"
					>Terms</a
				>
			</nav>
				...
				<Dialog.Content class="border border-border shadow-card/30 shadow-lg">
					...
					<Dialog.Footer class="mt-4">
						...
						<Button
							size="sm"
							variant="outline"
							href="https://github.com/darrelhong/openplays"
							target="_blank"
							rel="external noopener noreferrer"
						>
							<svg
