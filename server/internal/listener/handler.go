...
func HandleMessage(ctx context.Context, store MessageStore, source, senderUsername, senderName, msgText string, msgTime time.Time, sourceMessageID, sourceGroup *string) (HandleResult, error) {
